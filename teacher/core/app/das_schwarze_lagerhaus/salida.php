...
// Localhost
// header('refresh:2; url=http://localhost/Zettatronics/iem/teacher/');

// Developer
// header('refresh:2; url=https://aula.iemueem.edu.mx/Developer/iem/teacher/');

// UAT
// header('refresh:2; url=https://aula.iemueem.edu.mx/UAT/iem/teacher/');

// Servicios
header('refresh:2; url=https://aula.iemueem.edu.mx/Servicios/iem/teacher/');
