...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <img src="https://aula.iemueem.edu.mx/Servicios/iem/assets/images/logo_blanco_acostado.png" width="100px" height="auto" alt=""/>
...
-->
	...
	<div class="container-fluid" style="margin: 20px;">
		...
		<div class="small-box bg-maroon" style="background-color: #D81A60 !important; border-left: 15px solid #092944; box-shadow: 0 12px 20px -10px rgb(0 0 0 / 78%), 0 4px 20px 0px rgb(0 0 0 / 12%), 0 7px 8px -5px rgb(0 188 212 / 20%);padding-top: 12px;">
...
<!--Crea un nuevo directorio-->
			...
			<?php if ($data['enableUploads']): ?>
				...
				<div class="row">
					...
					A continuación se muestran las constancias digitales de los cursos que ha tomado de manera presencial o en línea en nuestra casa de estudios.<br><br>

					Si tiene alguna duda, por favor contacte a su Coordinación Académica. 
