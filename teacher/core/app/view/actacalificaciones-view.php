...
<div class="row">
	<div class="col-md-12">
        ...
        <div style="display: flex; align-items: center;">
            <div>
                <img src="../assets/images/logo_actas_iem.png" width="60" height="auto" alt="" />
            </div>
            <div style="margin-left: 10px;">
                <h3>Acta Definitiva de Calificaciones</h3>
                		<h5><b>Asignatura:</b> <?php echo $asignation->getAsignature()->name; ?> <br>
        			<b>Grupo:</b> <?php echo $team->grade . " - " . $team->letter; ?>
        			<b>Ciclo Escolar:</b> <?php echo $period->name; ?>
        		</h5>
            </div>
        </div>
        	...
        	<td align="center" colspan="4"><button class="btn btn-primary" onclick="window.print()"><i class="fa fa-print"></i> Imprimir o Guardar <i class="fa fa-download"></i> </button></td>
					...
					<table class="table table-bordered table-hover">
						...
						?>
							<tr>
								...
								<td style="font-size: 11px"><?php echo $alumn->code; ?></td>
								<td style="font-size: 11px"><?php echo $alumn->name . " " . $alumn->lastname; ?></td>
								...
								?>
									...
									<td align="center">
										...
										foreach ($subs as $sb) : ?>
											...
											if ($exist != null and is_numeric($exist->val)) {
												$cnt++;
												$sum += $exist->val;
												$cc++;
												$pp += $exist->val;
  ...
  <span class="input-group-addon" id="basic-addon1"><?php echo $sb->name; ?></span>
        <input type="text" class="form-control" name="val-<?php echo $alumn->id; ?>-<?php echo $sb->id; ?>" value="<?php if ($exist != null) {
						...
						<table>
							<tr>
								<td colspan="4" align="center">Se expide la presente acta en la Ciudad de México con fecha del <?php $arrayMeses = array('Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre');
