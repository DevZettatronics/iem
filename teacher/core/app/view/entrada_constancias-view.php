...
header('refresh:4; url=https://aula.iemueem.edu.mx/Servicios/iem/teacher/core/app/anerkennungen/');
...
.loader {
  ...
  border: 16px solid #D785A3;

  border-radius: 50%;

  border-top: 16px solid #D81A60;
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    	...
    	<td height="0" align="center" valign="middle"  class="verde">
			...
			<!--<img src="images/1341501451_clean.png" width="50" height="50">-->
	   		...
	   		<h2>Cargando Constancias Digitales</h2>
