<?php
class LetterData {
	public static $tablename = "letter";
...
// partiendo de que ya tenemos creado un objecto LetterData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new LetterData());
	}

	public static function getAll(){
		$sql = "select * from ".self::$tablename;
		$query = Executor::doit($sql);
		return Model::many($query[0],new LetterData());
	}
