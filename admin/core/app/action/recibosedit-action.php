    ...
    if ($_FILES["filename"]) {
        ...
        if ($_FILES["filename"]["name"]) {
            ...
            if (move_uploaded_file($fuente, $carpeta . '/' . $archivonombre)) {
                ...
                $sqlprincipal = mysqli_query($con, "UPDATE recibos SET filename='" . $archivonombre . "',importe='" . $importe . "',folio='" . $folio . "',created_at='" . $created_at . "' WHERE code_user='" . $alumn_id . "'");
