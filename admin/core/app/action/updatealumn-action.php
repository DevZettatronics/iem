...
if(count($_POST)>0){
	...
	if($_POST["password"]!=""){ $user->password=sha1(md5($_POST["password"])); $user->update_password(); }
	if($_POST["c1_password"]!=""){ $user->c1_password=sha1(md5($_POST["c1_password"])); $user->update_c1_password(); }
