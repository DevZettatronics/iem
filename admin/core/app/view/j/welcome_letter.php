...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm" style="font-size: 12px; font-family: helvetica ;" backimg="">
	...
	<page_footer pageset="old" class="footer">
		...
		<div style="margin-bottom:20px;border-top: solid 1px #000;text-align: center">
			...
			<p style="font-size: 9px; margin:0px; padding:0px;">Calle Corregidora SN Paraje Xometitla Centro, Municipio de Capulhuac, Estado de México CP 52700.</p>

			<p style="font-size: 9px;">Línea IEM (713) 133 52 38&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CORPORATIVO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;www.iemueem.edu.mx</p>
	...
	INNER JOIN team	ON  team.id = asig.team_id and team.id_identifica = '101'
	...
	<div class="test">
		...
		<div class="image1">
			...
			<img style="width: 60%; height: auto;" src="https://aula.iemueem.edu.mx/Servicios/iem/admin/core/app/view/j/img/logo_IEM.jpg">
		...
		<div class="title">
			...
			<h4 class="uni" style="font-size: 15px">UNIVERSIDAD EJECUTIVA DEL ESTADO DE MÉXICO</h4>

			<h5 class="uni">COORDINACIÓN DE CONTROL ESCOLAR<br>HISTORIAL ACADÉMICO</h5>
		...
		<div class="image">
			...
			<img style="width: 100%; height: auto;" class="img1" src="https://aula.iemueem.edu.mx/Servicios/iem/admin/core/app/view/j/img/marca_escudo2.jpg">
	...
	<div style="position:absolute; bottom:60px; left:5%">
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<p style="font-size:10px;margin-left:0px;text-align:left;"><strong>TOTAL DE ASIGNATURAS PRESENTADAS: </strong><?php echo $contador . " de " . $total_asignaturas ?><br>

				    <strong>CREDITOS OBTENIDOS : </strong><?php echo $a_contador_cre . " de " . $t_contador_cre ?></p>

				</td>

				<td>

					<p style="font-size:10px;margin-left:-220px;text-align:rigth; font-weight: bold;">PROMEDIO: <b><?php echo  $pro . " " ?> <?php echo strtoupper($h) ?></b></p><br>
			...
			<tr>
				...
				<td>
					...
					<p style="margin-top: 3px;font-size:8px;margin-left:0px;text-align:rigth;">* La escala de calificaciones es de 5 (cinco) a 10 (diez) y la minima aprobatoria es de 6 (seis).</p>
			...
			<tr>
				...
				<td>
					...
					<p style="margin-top: 3px;font-size:7px;margin-left:0px;text-align:rigth;">* Las asignaturas cursadas en otras instituciones educativas y validadas por la DGAIR - SEP

					  se anotarán con la abreviatura REV (revalidación) una vez sea emitido el Certificado Parcial o Total.</p>
			...
			<tr>
				...
				<td style="text-align: right; font-weight: bold">
					...
					<p style="font-size:10px;margin-left: -120px;text-align:rigth;">RVOE SEP: <?php echo $rvoe ?></p>
			...
			<tr>
				...
				<td style="font-size:8px;">FECHA DE EMISIÓN:</td>
