...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm" style="font-size: 12px; font-family: helvetica ;" backimg="">
	...
	INNER JOIN team	ON  team.id = asig.team_id and team.id_identifica = '104'
    ...
    /* SELECT count(*) contador, AVG(cf.calificacion) promedio

	FROM calificaciones_finales cf where cf.person_id=$id and (cf.calificacion>=5)"; */
