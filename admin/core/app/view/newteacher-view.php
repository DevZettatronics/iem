  ...
  <div class="col-md-12">
    ...
    <form class="form-horizontal" method="post" id="addcategory" action="index.php?action=teachers&opt=add" role="form">
      ...
      <div class="form-group">
        <label for="inputEmail1" class="col-lg-2 control-label">Usuario correo</label>
        <div class="col-md-6">
          <input type="text" name="code" required class="form-control" id="code" placeholder="Usuario">
        </div>
      </div>
      ...
      <div class="form-group">
        <label for="inputEmail1" class="col-lg-2 control-label">Año de nacimiento*</label>
        <div class="col-md-6">
          <input type="text" name="year" class="form-control" id="year" placeholder="Año de nacimiento">
        </div>
      </div>
