<div class="row">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Matrícula GES</label>
    <div class="col-md-6">
      <input type="text" name="code" required class="form-control" id="code" placeholder="Matrícula GES">
    </div>
  </div>
