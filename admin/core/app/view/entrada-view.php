...
header('refresh:4; url=/teacher/core/app/das_schwarze_lagerhaus/');
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    	...
    	<td height="0" align="center" valign="middle"  class="verde">
			...
			<!--<img src="images/1341501451_clean.png" width="50" height="50">-->
	   		<h2>Ingresando al Contenedor</h2>
  		...
  		<tr>
    	<td height="35" align="center" valign="top"  class="msjnegritas">Estoy Cargando la Información</br></br> Por favor Espere...</td>
  		</tr>
