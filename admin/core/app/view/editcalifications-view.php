...
?>
	<div class="row">
		<div class="col-md-12">
			...
			<a href="./?view=teams&opt=general1&id=<?php echo $team->id; ?>&period_id=<?php echo $period->id; ?>" class="btn btn-default"><i class="fa fa-arrow-left"></i> Regresar a Reporte de Calificaciones</a>
			<a href="./?view=teamasignatures&opt=all&id=<?php echo $team->id; ?>&period_id=<?php echo $period->id; ?>" class="btn btn-default"><i class="fa fa-arrow-up"></i> Ir a Asignaturas del Grupo</a>
			<br><br>
								...
								<?php foreach ($alumns as $alumnx) {
									...
									<tr>
										...
										?>
											...
											<?php $opcionOb = CalificationFinalData::getObservation($alumn->id,$asignation->id);
												// var_dump($opcionOb);
												// echo $alumn->id;
												// echo $opcionOb->observaciones;
												// echo "<br>";
											?>
											<td>
												<select name="option[<?php echo $alumn->id; ?>]" class="form-control text-center">
													<option value="0">Ordinario</option>
													<option value="1" <?php echo (intval($opcionOb->observaciones) == 1) ? "selected" : ""; ?>> (EE) - Examen Extraordinario</option>
													<option value="2" <?php echo (intval($opcionOb->observaciones) == 2) ? "selected" : ""; ?>> (REV) - Revalidación</option>
												</select>
											</td>
