...
<page backtop="0mm" backbottom="0mm" backleft="4mm" backright="4mm" style="font-size: 11px; font-family: helvetica" backimg="">
		...
		<table border=0 style="width:100%;margin:2mm 0px;font-size:10px" cellspacing=0>
			<tr>
				...
				<td style="width:34mm;text-align:left;" class=''>Descripción</td>
				<td style="width:10mm;text-align:right;" class=''>P.U</td>
				<td style="width:10mm;text-align:right;" class=''>TOTAL</td>
			</tr>
		...
		while ($row=mysqli_fetch_array($sql)){
			...
			<tr>
				...
				<td style="width:10mm;text-align:right;" ><?php echo number_format($unit_price,$currency_format['precision_currency'],$currency_format['decimal_separator'],$currency_format['thousand_separator']);?></td>
				<td style="width:10mm;text-align:right;"><?php echo number_format($precio_total,$currency_format['precision_currency'],$currency_format['decimal_separator'],$currency_format['thousand_separator']);?></td>
            </tr>	
			<?php
		}
		...
		!-->
		<tr>
			<td style='text-align:right' class='' colspan="3" >Subtotal <?php echo $moneda;?></td>
		...
		?>
		<tr>
			<td style='text-align:right' class='' colspan="3" >Descuento <?php echo $descuento;?>% <?php echo $moneda;?></td>
		...
		?>
		<tr>
			<td style='text-align:right' class='' colspan="3" ><?php echo $tax_txt;?> <?php echo $tax;?>% <?php echo $moneda;?></td>
		...
		<tr>
			<td style='text-align:right' class='' colspan="3" ><b>Total <?php echo $moneda;?></b></td>
		...
		<table border=0 style="width:100%;" cellspacing=0>
			...
			<tr>
				<td style="width:100%;text-align:left;" class=''>CAJERO: <?php echo get_id('users','fullname','user_id',$sale_by);?> </td>
			</tr>
		</table>
		<br><br>
		<table border=0 style="width:100%;" cellspacing=0>
			<tr>
				<td class='top bottom' style="width:100%;text-align:center;font-size:10px" >CAMBIOS DENTRO DE LOS 7 DÍAS SIGUIENTES PRESENTANDO SU COMPROBANTE DE PAGO</td>
			</tr>
