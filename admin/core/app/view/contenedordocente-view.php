...
<form class="form-horizontal" method="post" id="addproduct" action="" role="form">
	...
	<div class="form-group">
    	<label for="inputEmail1" class="col-lg-2 control-label" >
			Esta activo <i class="	glyphicon glyphicon-check"></i></label>
    	<div class="col-md-6">
			<div class="checkbox">
    			<label>
...
<div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">
		Correo Institucional <i class="	glyphicon glyphicon-envelope"></i></label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">
		Te haz identificado como: <i class="	glyphicon glyphicon-user"></i></label>
    <div class="col-md-6">
      <input type="text" name="name" value="<?php echo $user->name;?> <?php echo $user->lastname;?>" class="form-control" id="name" placeholder="Nombre" disabled="disabled">
		...
		<div class="form-group">
    		<label for="inputEmail1" class="col-lg-2 control-label">
				Usuario de Sistema <i class="	glyphicon glyphicon-heart"></i> </label>
    		<div class="col-md-6">
...
<form class="form-horizontal" name="form1" method="post" action="?view=verificar">  
				...
				<label for="inputEmail1" class="col-lg-2 control-label">
					...
					<div class="col-md-6">
						<input name="username" type="tel" class="form-control" placeholder="Usuario" id="username" aria-describedby="sizing-addon1" value="<?php echo $user->username;?>">
					</div>
				</div>	
