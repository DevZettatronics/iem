...
$busqueda= "SELECT * FROM `user` WHERE `username` ='$username' AND `year` ='$year'";
...
// 11111111111111111111111111111111111111111111111111111111111111	
	...
	if ($is_active=="1" && $kind=="1" or $is_active=="1" && $kind=="8")     //1A
	{ 
	session_start();
	$_SESSION['1B']=true;
	$_SESSION['id']=$res['id'];
...
//	$_SESSION["directorio"]=$res['directorio'];	
	...
	<script type="text/javascript">
		location.href="index.php?view=entrada";
	</script>
	...
	<script type="text/javascript">
		location.href="index.php?view=error&id=<?php if (isset($_SESSION["user_id"])) {
