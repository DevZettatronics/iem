...
<page backtop="0mm" backbottom="0mm" backleft="4mm" backright="4mm" style="font-size: 11px; font-family: helvetica" backimg="">
	...
	<table border=.2 style="width:100%;margin:2mm 0px;font-size:10px" cellspacing=0>
		...
		<?php
		$sumador_total = 0;
		$sql = mysqli_query($con, "select * from products, sale_product, sales  where sale_product.sale_id=sales.sale_number  and products.product_id=sale_product.product_id and sale_product.sale_id='$sale_id'");
		...
		$sql1 = mysqli_query($con, "SELECT * FROM sales where id_plan = $sale_id ");
		...
		<tr>
			...
			<td style='text-align:right' class=''> <?php echo $fecha_inicio_formateada; ?></td>
