...
<page backtop="0mm" backbottom="0mm" backleft="4mm" backright="4mm" style="font-size: 11px; font-family: helvetica" backimg="">
	...
	<!-- <table border=0 style="width:100%;margin:5mm 0px" cellspacing=0>
		...
		?>
			<tr style="width:50%;" >
				<td style="width:50%;" class="bottom"><b>VINCULACION</b> <?php echo ''; ?><br></td>
			</tr>
	...
	<table border=0 style="width:100%;margin:5mm 0px" cellspacing=0>
			...
			?>
				<tr>
					...
					<td style="width:40%;text-align:center;"class='bottom top'>Fecha de pago correspondiente: <b><?php echo $fecha_formateada; ?></b></td>
				</tr>
				<tr>
					<td style="width:59.5%;text-align:left;"class='bottom'><b>NOMBRE:</b> <?php echo mb_strtoupper($union_nombre, 'UTF-8'); ?><br></td>
					<td style="width:40%;text-align:center;"class='bottom'>Fecha de pago:<b><?php echo date('d/m/y'); ?></b></td>
				</tr>
			<?php
				}else{
			?>
				<tr>
					...
					<td style="width:40%;text-align:center;"class=''>Fecha de pago correspondiente: <b><?php echo $fecha_formateada; ?></b></td>
				</tr>
				<tr>
					<td style="width:40%;text-align:left;"class=''><b>ESTUDIANTE:</b> <?php echo $union_nombre; ?><br></td>
					<td style="width:40%;text-align:center;"class=''>Fecha de pago:<b><?php echo date('d/m/y'); ?></b></td>
				</tr>
				<?php if ($namePeriodo !== 0): ?>
					<tr>
						<td style="width:40%;text-align:left;" class=''><b>CUATRIMESTRE:</b> <?php echo $namePeriodo; ?><br></td>
					</tr>
				<?php endif; ?>

				<?php if ($nameProgram !== 0): ?>
					<tr>
						<td style="width:50%;text-align:left;" class=''><b>CARRERA:</b> <?php echo $nameProgram; ?><br></td>
					</tr>
				<?php endif; ?>

				<?php if ($nameProgram !== 0): ?>
					<tr>
						<td style="width:40%;text-align:left;" class=''><b>MODALIDAD:</b> <?php echo $typeProgram; ?><br></td>
					</tr>
				<?php endif; ?>
			<?php
				}
