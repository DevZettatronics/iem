...
/*
VentanaCentrada('new-sale-ticket-pdf.php?
person_id=' + person_id + '&
...
if (isset($_GET["id"])) {
    ...
    try {
        ...
        $mail->setFrom('soporte@zettatronics.com.mx', 'Nuevo Miembro Registrado');
        ...
        // $mail->addStringAttachment($pdf, 'CartaBienvenida.pdf');
    ...
    $slq = mysqli_query($con, "SELECT * FROM person");
    while($datos = mysqli_fetch_array($slq)){
        var_dump($datos);
        echo "<br><br><br><br>";
    }
}
