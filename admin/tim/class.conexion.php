...
*/
...

	{
		...
		public function operacion_cancelar($apikey, $keyCSD, $cerCSD, $passCSD, $uuid, $rfcEmisor, $rfcReceptor, $total, $id)

		{
			$motivo = "03";
			$res = $this->client->cancelar($apikey, $keyCSD, $cerCSD, $passCSD, $uuid, $rfcEmisor, $rfcReceptor, $total, $motivo);
			...
			file_put_contents("../storage/cancelaciones/acuse_cancelacion_factura_" . $id . ".xml", $acuse);
