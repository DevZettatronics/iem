  ...
  <div class="row">
    <form class="form-horizontal" method="post" id="new_register" action="" role="form" autocomplete="off">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="datos_personales">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" <?php echo $readonly_nationality ?> class="form-control" id="nacionalidad" name="nacionalidad" placeholder="Nacionalidad" value="<?php echo $user->nationality ?>">
                </div>
            ...
            <div class="tab-pane" id="direccion">
              ...
              <div class="form-group ">
                ...
                <div class="col-sm-2">
                  <input type="text" <?php echo $readonly_address ?> class="form-control" id="numero_interior" name="numero_interior" value="<?php echo $numero_interior ?>" placeholder="Numero Interior">
                </div>
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="pull-right"><a href="./?view=repository&code=<?php echo  $user->code ?>" class="btn bg-red"><i class='fa fa-th-list'></i> Mis Documentos Cargados</a></li>
          </ul>
            ...
            <div class="tab-pane active" id="documentacion">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-4">
                    <!-- <label for="identificacion" class="col-lg-3 control-label">Programa Educativo</label> -->
              ...
              <div class="form-group hidden" id="bachillerato" name="bachillerato">

                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Identificacion Oficial (padre o tutor)</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">Comprobante de Domicilio (padre o tutor)</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">CURP (estudiante)</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Acta de Nacimiento (estudiante)</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">Certificado de Secundaria (estudiante)</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
              ...
              <div class="form-group hidden" id="licenciatura" name="licenciatura">

                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Identificacion Oficial</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">Comprobante de Domicilio</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">CURP</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Acta de Nacimiento</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">Certificado de Bachillerato</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
              ...
              <div id="maestria" name="maestria" class="form-group hidden">
                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Identificacion Oficial</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                ...
                <div class="col-md-12">
                  ...
                  <label for="identificacion" class="col-lg-2 control-label">Certificado Total de Licenciatura</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">Titulo de Licenciatura</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Cédula de Licenciatura</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
              ...
              <div id="doctorado" name="doctorado" class="form-group hidden">
                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Identificacion Oficial</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                ...
                <div class="col-md-12">
                  ...
                  <label for="identificacion" class="col-lg-2 control-label">Certificado de Maestria</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                  <label for="identificacion" class="col-lg-2 control-label">Titulo de Maestria</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
                <div class="col-md-12">
                  <label for="identificacion" class="col-lg-2 control-label">Cédula de Maestria</label>
                  <div class="col-md-2">
                    <input type="file" id="docs[]" multiple name="docs[]" class="form-control">
                  </div>
                </div>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-2">
          <button type="submit" class="btn bg-navy">Actualizar Información</button>
        </div>
        <div class="col-lg-5"></div>
    </form>
  </div>
...
<script>
  function mostrar(id) {
    if (id == "bachillerato") {
      $("#bachillerato").removeClass('hidden');
      $("#licenciatura").addClass('hidden');
      $("#maestria").addClass('hidden');
      $("#doctorado").addClass('hidden');
    }

    if (id == "licenciatura") {
      $("#bachillerato").addClass('hidden');
      $("#licenciatura").removeClass('hidden');
      $("#maestria").addClass('hidden');
      $("#doctorado").addClass('hidden');
    }
