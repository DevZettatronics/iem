...
elseif (empty($_POST['estado'])) {
	$errors[] = "Por favor selecciona un estado en la sección de Dirección";
}
...
} elseif (empty($_POST['telemergencia']) || empty($_POST['namecontacto'])) {
	$errors[] = "Por favor completa la sección de contacto";
